package com.example.gd11_d_0932
...
import com.example.gd11_d_0932.adapters.MahasiswaAdapter
import com.example.gd11_d_0932.api.MahasiswaApi
import com.example.gd11_d_0932.models.Mahasiswa
    ...
    private fun allMahasiswa(){
        ...
        val stringRequest : StringRequest = object:
            StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                ...
                // aslinya:
                var mahasiswa : Array<Mahasiswa> = gson.fromJson(
                    response, // <-- ini yang diubah
                    Array<Mahasiswa>::class.java
                )

                // modified:
//                val jsonObject = JSONObject(response) // <-- tambahkan ini dulu
//                var mahasiswa : Array<Mahasiswa> = gson.fromJson(
//                    jsonObject.getJSONArray("data").toString(), // <-- biar kita bisa ambil data dari `data` yang ada di response, bukan langsung dari response
//                    Array<Mahasiswa>::class.java
//                )
